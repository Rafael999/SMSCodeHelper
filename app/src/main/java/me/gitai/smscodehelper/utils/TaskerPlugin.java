...
public class TaskerPlugin {
    ...
    /**
     * 	Action that the TaskerActivity for an event plugin should be launched by
     */
     ...
     *
     * Used in TaskerActivity, before setResult().
     *
    ...
    public static class Setting {
         ...
         */
        public final static String 	EXTRA_REQUESTED_TIMEOUT = EXTRAS_PREFIX + "REQUESTED_TIMEOUT";
    ...
    public static class Host {
         ...
         * intents to any TaskerActivity, FireReceiver or QueryReceiver.
         *
