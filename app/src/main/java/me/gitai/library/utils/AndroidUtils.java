...
public final class AndroidUtils {
    ...
    public static boolean isIceCreamSandwichOrLater = Build.VERSION.SDK_INT >= VERSION_CODES.ICE_CREAM_SANDWICH;

    public static boolean isPreIceCreamSandwich = Build.VERSION.SDK_INT < VERSION_CODES.ICE_CREAM_SANDWICH;

    public static boolean isJellyBeanOrLater = Build.VERSION.SDK_INT >= VERSION_CODES.JELLY_BEAN;

    public static boolean isKitkatOrLater = Build.VERSION.SDK_INT >= VERSION_CODES.KITKAT;

    public static boolean isPreLollipop = Build.VERSION.SDK_INT < VERSION_CODES.LOLLIPOP;

    public static boolean isLollipopOrLater = Build.VERSION.SDK_INT >= VERSION_CODES.LOLLIPOP;

    public static boolean isPreMarshmallow = Build.VERSION.SDK_INT < VERSION_CODES.M;

    public static boolean isMarshmallowOrLater = Build.VERSION.SDK_INT >= VERSION_CODES.M;
