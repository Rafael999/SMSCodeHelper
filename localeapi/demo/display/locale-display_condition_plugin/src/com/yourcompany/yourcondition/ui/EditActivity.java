...
import com.yourcompany.yourcondition.bundle.BundleScrubber;
...
public final class EditActivity extends AbstractPluginActivity
{
     ...
     */
    /* package */static String generateBlurb(final Context context, final boolean isDisplayOn)
    {
        if (isDisplayOn)
        {
     ...
     */
    /* package */static int getPositionForIdInArray(final Context context, final int arrayId,
                                                    final int elementId)
    {
     ...
     */
    /* package */static int getResourceIdForPositionInArray(final Context context, final int arrayId,
                                                            final int position)
    {
        if (Constants.IS_PARAMETER_CHECKING_ENABLED)
        {
